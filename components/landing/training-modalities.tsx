...
const modalities = [
  {
    ...
    title: "Musculação",
    description:
      "Equipamentos biomecânicos premium para ganho de força e hipertrofia.",
    image:
  ...
  },
  {
    ...
    title: "Boxe",
    description:
      "Treino de boxe profissional para técnica, cardio e defesa pessoal.",
    image:
  ...
  },
  {
    ...
    description:
      "Movimentos naturais que trabalham o corpo todo com eficiência máxima.",
    image:
      ...
      >
        ...
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          ...
          <p className="text-sm sm:text-base md:text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed">
            Treinos especializados com o melhor da tecnologia e orientação
            profissional
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {modalities.map((modality, index) => (
            <div
              key={modality.id}
              className="stagger-child group relative h-64 sm:h-80 md:h-96 rounded-lg sm:rounded-xl overflow-hidden hover:scale-105 transition-all duration-300 cursor-pointer"
            >
              {/* Background image */}
              <Image
                src={modality.image}
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6">
                ...
                <p className="text-slate-300 text-xs sm:text-sm mt-1 leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-300">
