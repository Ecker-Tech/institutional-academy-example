...
export function Results() {
  ...
  return (
    <section ref={sectionRef} id="resultados" className="py-24 bg-black">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {transformations.map((item, index) => (
            <Card
              key={index}
              className="animate-on-scroll opacity-0 duration-700 bg-zinc-900/50 border-zinc-800 overflow-hidden group"
