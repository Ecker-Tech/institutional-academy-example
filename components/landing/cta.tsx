    ...
    <section id="contact" className="relative py-24 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
          Junte-se a centenas de membros Elite que já estão alcançando seus
          objetivos em PULSAR. Sua jornada começa hoje.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button className="group relative px-10 py-4 font-bold text-lg text-foreground overflow-hidden rounded-lg w-full sm:w-auto">
            <div className="absolute inset-0 bg-linear-to-r from-primary to-secondary group-hover:opacity-110 transition-opacity" />
