...
export function Pricing() {
  ...
  return (
    <section id="pricing" ref={ref} className="relative py-12 sm:py-16 md:py-24 bg-background">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {pricingPlans.map((plan, index) => (
            ...
            >
              ...
              {plan.highlighted && (
                <div className="relative bg-gradient-to-r from-primary to-lime-500 px-3 py-1.5 sm:px-4 sm:py-2 text-center font-bold text-primary-foreground text-xs sm:text-sm">
                  Melhor Escolha
                </div>
              )}
              ...
              <div className="relative p-5 sm:p-6 md:p-8">
                ...
                <div className="mb-4 sm:mb-6">
                  <h3 className="text-xl sm:text-2xl font-bold text-white mb-1.5 sm:mb-2">{plan.name}</h3>
